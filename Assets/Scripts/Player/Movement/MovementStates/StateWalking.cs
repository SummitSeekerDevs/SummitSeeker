...
public class StateWalking : IMovementState
{
    ...
    public StateWalking(MovementContext movementContext, PlayerMovementConfig movementConfig)
    {
    ...
    public List<MovementStateMachine.TransitionLinkTypes> GetTransitionsList()
    {
        return new List<MovementStateMachine.TransitionLinkTypes>
        {
            ...
            MovementStateMachine.TransitionLinkTypes.LinkCrouching,
        };
    }
    ...
    {
        Debug.Log("Walking");
        _movementContext.SetMoveSpeed(_movementConfig.walkSpeed);
    }
